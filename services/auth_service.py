...
"""
Serviço de autenticação com criptografia de senhas — Firestore.
A lógica de negócio permanece a mesma. Apenas o repositório subjacente mudou.
"""
import hashlib
import secrets
...
class AuthService:
    ...
    def registrar(self, nome: str, email: str, senha: str, confirma_senha: str,
        ...
        # ⚠️ Firestore NÃO tem constraint UNIQUE nativa.
        # Verificamos manualmente se o email já existe.
